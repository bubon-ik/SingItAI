...
Start the wizard-recommended Cloudflare quick tunnel to the WhatsApp webhook
port. In Meta App Dashboard -> WhatsApp -> Configuration, set:

```text
Callback URL: https://<quick-tunnel>.trycloudflare.com/whatsapp/webhook
...
10. Approve in the selected channel: `YES` in iMessage or the bound Approve
    button in WhatsApp.
